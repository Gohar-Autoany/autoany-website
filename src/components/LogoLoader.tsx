        ...
        return (
          ...
          >
            <div className="relative">
              ...
              {stage >= 2 && (
                <>
                  <div className="absolute inset-0 bg-[#41B8D5]/10 rounded-full animate-ping"></div>
                  {stage >= 3 && (
                    <div className="absolute inset-0 bg-[#41B8D5]/5 rounded-full animate-ping animation-delay-500"></div>
                  )}
                </>
              )}
            </div>
        ...
        return (
          ...
          >
            <div className="relative">
              ...
              {stage >= 2 && (
                <>
                  <div className="absolute inset-0 border-4 border-[#41B8D5]/30 rounded-full animate-ping"></div>
                  <div className="absolute inset-0 border-2 border-[#41B8D5]/20 rounded-full animate-ping animation-delay-500"></div>
                </>
              )}
            </div>
          </div>
