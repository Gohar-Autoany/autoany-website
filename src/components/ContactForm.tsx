...
const Hero: React.FC<HeroProps> = ({ onOpenContactForm }) => {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen w-full bg-white pt-16"
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 20% 80%, rgba(65, 185, 213, 0.1) 0%, transparent 50%)",
        }}
      />
      ...
      <div className="relative">
        ...
        <div className="min-h-[80vh] flex flex-col items-center justify-center px-8 text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-[#6D6E71] leading-relaxed font-normal max-w-3xl mb-12">
            Partner with autoany to identify high-impact automation
            opportunities, implement intelligent solutions, and transform your
            business operations with measurable results.
          </p>
